...
struct LazyVGrid_LazyHGridView: View {
    var body: some View {
        ...
        NavigationView {
            ScrollView(.horizontal) {
                LazyHGrid(rows: gridItems, content: {
                    ForEach(images, id: \.self) { element in
                        VStack {
            ...
            }.navigationTitle("Grid de SF Symbols")
        }
    }
}

struct LazyVGrid_LazyHGrid_Previews: PreviewProvider {
    static var previews: some View {
        LazyVGrid_LazyHGridView()
    }
}
